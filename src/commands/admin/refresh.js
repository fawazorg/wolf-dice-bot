 ...
 * Synchronizes bot state with database and updates any unset channel configurations.
 * @module commands/admin/refresh
 */

import { refreshInactiveChannels } from "../../database/helpers/channel.js";
 ...
 * @returns {Promise<Response<MessageResponse>>} Response with list of refreshed channels or unauthorized message
 */
export default async (client, command) => {
  ...
  const names = await refreshInactiveChannels(client);
